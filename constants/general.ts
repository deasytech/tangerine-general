...
export const NAV_LINKS = [
  ...
  },
  {
    ...
    subMenu: [
      { href: "/corporate-plans/aviation-insurance", key: "aviation-insurance", label: "Aviation" },
      { href: "/corporate-plans/marine-insurance", key: "marine-insurance", label: "Marine" },
      { href: "/corporate-plans/engineering-insurance", key: "engineering-insurance", label: "Engineering" },
    ]
  },
  {
    href: "/retail-plans",
    ...
    label: "Retail Plans",
    subMenu: [
      { href: "/retail-plans/motor-insurance-comprehensive", key: "motor-insurance-comprehensive", label: "Motor" },
      { href: "/retail-plans/fire-insurance", key: "fire-insurance", label: "Fire" },
      { href: "/retail-plans/householder-comprehensive", key: "householder-comprehensive", label: "Householder" },
      { href: "/retail-plans/travel-insurance", key: "travel-insurance", label: "Travel" },
    ]
  },
...
export const GENERAL_INSURANCE = [
  ...
  },
  {
    ...
    description: "Our strategic initiative is to provide value for our stakeholders, retain customers’ trust and consistently achieve operational excellence."
  },
  {
    image: "/icons/bars-progress.svg",
    title: "Online Policy Management",
    description: "The company has built a strong risk management profile. Driven by innovation and cutting-edge service delivery, our products are distributed and managed digitally."
  },
  {
    image: "/icons/coin.svg",
    title: "Competitive Rates & Best Quality",
    description: "Customers can make payments for services through their bank account, PoS terminals or online payment platforms. This is not just convenient but cost effective."
  },
];
...
export const FOOTER_LINKS = [
  ...
  },
  {
    title: "Retail plans",
    links: [
      { name: "Motor Insurance - Comprehensive", href: "/retail-plans/motor-insurance-comprehensive" },
      { name: "Motor Insurance - Third-Party", href: "/retail-plans/motor-insurance-third-party" },
      { name: "Fire Insurance", href: "/retail-plans/fire-insurance" },
      { name: "Householder Comprehensive", href: "/retail-plans/householder-comprehensive" },
      { name: "Travel Insurance", href: "/retail-plans/travel-insurance" },
    ],
  },
  {
    title: "Compliance",
...
export const BENEFITS_OFFERED = [
  {
    ...
    icon: "/icons/car-burst.svg",
    text: "Protect yourself on the road (motor insurance), secure your home (fire & household insurance), and safeguard your travels (travel insurance).",
  },
  {
    title: "Tailored coverage",
    icon: "/icons/car-tilt.svg",
    text: "Choose from a range of options to ensure your motor vehicle, home, and travel needs are covered (e.g., third-party vs. comprehensive motor insurance, content add-ons for household insurance).",
  },
  {
    title: "Simplified experience",
    icon: "/icons/truck-tow.svg",
    text: "Enjoy a streamlined process for quotes, payments, and claims across all your insured areas - motor, travel, fire, and household.",
  },
];
...
export const PLANS = [
  {
    ...
    link: "/retail-plans/motor-insurance-comprehensive",
  ...
  },
  {
    ...
    link: "/retail-plans/motor-insurance-third-party",
    text: "Protect yourself on the road. This basic motor insurance plan offers essential coverage for third-party liabilities.",
  },
  {
    title: "Fire Insurance",
    link: "/retail-plans/fire-insurance",
  ...
  },
  {
    ...
    link: "/retail-plans/travel-insurance",
...
export const CORPORATE_PLANS = [
  {
    ...
    link: "/corporate-plans/marine-insurance",
    text: "Marine cargo insurance protects property during transit across different modes, while marine hull insurance covers ship damage expenses, focusing on the vessel's main body and machinery.",
  },
  {
    title: "Aviation & Energy",
    link: "/corporate-plans/aviation-energy",
    text: "Aviation insurance is insurance coverage geared specifically to the operation of aircraft and the risks involved in aviation ",
  },
  {
    title: "Agric Insurance",
    link: "/corporate-plans/agric-insurance",
    text: "We understand that every farm is different, with its own set of challenges and opportunities. That's why we offer customized insurance solutions that are tailored to meet your specific needs and circumstances",
  },
  {
    title: "Fire Insurance",
    link: "/corporate-plans/fire-insurance",
    text: "This insurance safeguards your home and belongings against burglary, fire, and other perils.",
  },
  {
...
export const MOTOR_THIRDPARTY_PLANS = [
  {
    title: "Eligibility",
    description: "18 years and above (with insurable interest)",
  },
  {
    title: "Policy Term",
    description: "Maximum of 12 months",
  },
  {
    title: "Premium Rate",
    description: `N15,000.00 Flat`,
  },
  {
    title: "Minimum Sum Assured",
    description: "N2,000,000.00",
  },
  {
    title: "Payment Plan",
...
export const FIRE_PLANS = [
  ...
  },
  {
    ...
    description: `N1,000,000.00`,
  },
  {
    title: "Maximum Sum Insured",
    description: "N20,000,000.00",
  },
  {
    title: "In-built Benefits",
    description: "Covers damage to insured's building due to fire, storm damage, Lightning, Malicious damage, overflow of tanks etc."
  },
  {
    title: "Payment Plan",
    description: "Annually, Biannually or Quarterly"
  },
];

export const HOUSEHOLDER_PLANS = [
  {
    title: "Eligibility",
    description: "18 years and above (with insurable interest)",
  },
  ...
  {
    title: "Premium Rate",
    description: `Building 0.25% <br /> Contents 0.65%`,
  },
  {
    title: "Minimum Sum Insured",
    description: "N1,000,000.00",
  ...
  {
    title: "In-built Benefits",
    description: `<ul><li>Burglary</li><li>Fire, Lightning, Explosion</li><li>Allied Perils</li><li>Personal Liability/Death Limit of Liability 100,000.00</li><li>Loss of rent/Alternative Accommodation Limit of Liability 20,000.00</li><li>Public Liability Limit of Liability 50,000.00</li></ul>`
  },
  {
    title: "Payment Plan",
    description: "Annually, Biannually or Quarterly"
...
export const TRAVEL_PLANS = [
  ...
  },
  {
    ...
    description: "Add Ons as requested",
  },
  {
    title: "In-built Benefits",
    description: `<ul><li>Loss of Luggage</li><li>Medical & Emergency Expenses</li><li>Dental Expenses</li><li>Delayed Departure</li><li>Trip Cancellation Expense</li></ul>`,
  },
  {
    title: "Payment Plan",
    description: "Annually"
...
export const MOTOR_COMPREHENSIVE_PLANS = [
  {
    title: "Eligibility",
    description: "18 years and above (with insurable interest)",
  },
  ...
  {
    title: "Maximum Sum Insured",
    description: "N49,000,000.00",
  },
  {
    title: "Payment Plan",
    description: "Annually, Bi-annually, and quarterly",
  },
];
...
export const FAQ = [
  ...
  {
    id: "4",
    question: "How do I purchase insurance from Tangerine General?",
    answer: "You can purchase insurance from Tangerine General by contacting them directly through their website, phone, or visiting one of their local offices. A representative will guide you through the process of selecting the appropriate coverage for your needs and provide you with a quote.",
  },
  {
    id: "5",
    question: "How long does it take to get approved for Tangerine General Insurance?",
  ...
  },
  {
    ...
    answer: "Yes, Tangerine General allows you to change your beneficiary at any time by completing a beneficiary change form.",
  },
  {
    id: "7",
    question: "What happens if I miss a premium payment?",
    answer: "Tangerine General typically offers a grace period for premium payments. If you miss a payment, you may have a certain amount of time to make the payment without penalty. However, it's essential to review your policy documents for specific details.",
  },
  {
    id: "8",
    question: "Are there any exclusions or limitations to Tangerine General Insurance policies?",
...
export const DIRECTORS = [
  {
    image: "/images/team/kwairanga.png",
    name: "Dr Umaru Kwairanga",
    position: "Chairman, Board of Directors",
  },
  {
    image: "/images/team/adeduro.png",
...
export const MANAGEMENT = [
  ...
  },
  {
    ...
    name: "Emmanuel Ajayi",
    position: "Ag. Head Investment",
  },
  {
    image: "/images/team/etta.png",
    name: "John Etta",
    position: "Ag. Head, Underwriting",
  },
  {
  ...
  },
  {
    ...
    name: "Oluwafeyi Shajobi",
    position: "Ag. Head, Reinsurance",
  },
];
...
<br>Staff Members
<br>Staff members are expected to whistle blow on transactions, operations and any other activities of the Company that involve fraud, corruption and misconduct, whether internal or external via the dedicated email address <a href="mailto:tangerineafrica.whistleblow@oalpconsulting.com" className="link">tangerineafrica.whistleblow@oalpconsulting.com</a>
<br>External Parties
<br>Parties external to the Company, however, are required to bring allegations and complaints of corruption, fraud and any other misconduct in the execution of any business of the Company or project(s) related to the Company to the knowledge of the Company via the Whistle blowing link on the Company's website or send an email to  <a href="mailto:tangerineafrica.whistleblow@oalpconsulting.com" className="link">tangerineafrica.whistleblow@oalpconsulting.com</a>
...
export const CLAIM_PROCESS = [
  {
    ...
    icon: "/icons/car-burst.svg",
    text: "Download and complete the claim form.",
  },
  {
    title: "Claim Form and Documents",
    icon: "/icons/car-tilt.svg",
    text: "Submit the form and required documents online to Tangerine's claims department at hello@tangerine.africa or visit the nearest Tangerine office.",
  },
  {
    title: "Confirmation of Claim Approval",
    icon: "/icons/truck-tow.svg",
    text: "Tangerine will confirm your claim approval via email or phone.",
  },
  {
    title: "Receive Settled Claim",
    icon: "/icons/truck-tow.svg",
    text: "Receive your settled claim through your chosen method, as communicated in the confirmation email or call.",
  },
];
