...
const LeadershipTeamPage = () => {
  return (
    <>
      <section className="max-container padding-container mt-24 md:mt-36">
        <p className="text-generic-500 uppercase font-gilroy-semibold mb-2">Leadership</p>
        <h2 className="bold-32 md:bold-48 text-orange-base mb-6">Board of Directors</h2>
      ...
      <section className="max-container padding-container mt-32">
        <h1 className="bold-32 md:bold-48 text-orange-base mb-6">Management Team</h1>
