    ...
    <>
      <section className="relative max-container padding-container flex flex-col gap-12 md:flex-row items-start w-full mt-24 md:mt-36">
        <div className="w-full space-y-3 flex-[2]">
          ...
          <p className="regular-18 text-generic-950 !leading-[145%]">Our fire insurance policy shields your building from a range of destructive events, including fire, storms, lightning, vandalism, and overflowing tanks.</p>
          <Link href="/get-quote">
      ...
      <section className="relative max-container padding-container mt-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-10">
          {FIRE_PLANS.map((item: { title: string; description: string }) =>
            <AvailableRidersCard
              key={item.title}
              name={item.title}
      ...
      <section className="relative max-container padding-container mt-32">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full px-8 py-6 bg-white rounded-xl flex flex-col justify-between border">
            <div className="flex-col justify-start items-start gap-2 flex my-8">
              <h3 className="regular-24 md:regular-32 text-orange-base">Householder Comprehensive</h3>
              <div className="regular-16 leading-4 text-generic-950" dangerouslySetInnerHTML={{ __html: "This insurance safeguards your home and belongings against burglary, fire, and other perils." }} />
            </div>
            <Link href="/retail-plans/householder-comprehensive">
              <Button variant="secondary" size="lg" className="w-fit gap-2">
                View details
                <ArrowRight size={18} />
              </Button>
          ...
          <div className="w-full px-8 py-6 bg-white rounded-xl flex flex-col justify-between border">
            <div className="flex-col justify-start items-start gap-2 flex my-8">
              ...
              <div className="regular-16 leading-4 text-generic-950" dangerouslySetInnerHTML={{ __html: "This travel insurance plan is available for travelers aged 3 months to 80 years old. Coverage lasts for 92 days (approximately 3 months) with premiums determined by a separate rate schedule." }} />
            </div>
