...
import { FAMILY_WELFARE_PLANS } from '@/constants/general'
    ...
    <>
      <section className="relative max-container padding-container flex flex-col gap-12 md:flex-row items-start w-full mt-36">
        <div className="w-full space-y-3 flex-[2]">
          ...
          <h1 className="bold-56 text-orange-900">Family Welfare Plan</h1>
        ...
        <div className="w-full flex-[3]">
          <Image src="/images/general/family-welfare-banner.png" alt="Family Welfare Plan" width={696} height={364} className="w-full object-contain" />
        </div>
      </section>
