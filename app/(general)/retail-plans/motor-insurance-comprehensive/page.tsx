...
import { MOTOR_COMPREHENSIVE_PLANS } from '@/constants/general'
    ...
    <>
      <section className="relative max-container padding-container flex flex-col gap-12 md:flex-row items-start w-full mt-24 md:mt-36">
        <div className="w-full space-y-3 flex-[2]">
          <BackWithBreadCrumbs page="Motor Insurance Comprehensive" />
          <h1 className="bold-32 md:bold-56 text-orange-900">Motor Insurance Comprehensive</h1>
        ...
        <div className="w-full flex-[3]">
          <Image src="/images/general/motor-comprehensive-banner.png" alt="Motor Insurance Comprehensive" width={696} height={364} className="w-full object-contain" />
        </div>
      </section>

      <section className="relative max-container padding-container mt-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-10">
          {MOTOR_COMPREHENSIVE_PLANS.map((item: { title: string; description: string }) =>
            <AvailableRidersCard
              key={item.title}
              name={item.title}
