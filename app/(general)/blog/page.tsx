...
import BlogCard from '@/components/general/cards/BlogCard'
import { POSTS } from '@/constants/general'
    ...
    <>
      <section className="relative max-container padding-container flex flex-col gap-12 md:flex-row items-center w-full mt-24 md:mt-44">
        <div className="w-full flex-[3]">
          <Image
            src="/images/general/blog_banner.png"
        ...
        <div className="w-full flex flex-col gap-6 flex-[2]">
          <h1 className="bold-32 md:bold-48 text-orange-900">Insurance Made Easy</h1>
          ...
          <Link href="/blog/international-toothache-day">
            <Button variant="ghost" className="gap-3 text-orange-900">
              Read More
              <ArrowRight size={16} />
            </Button>
          </Link>
      ...
      <section className="relative max-container padding-container mt-20">
        <h3 className="bold-32 md:bold-36 !font-gilroy-light">More Posts</h3>
