  ...
  return (
    <>
      ...
      <section className='relative max-container padding-container space-y-8 mt-16'>
        <div className='bg-orange-base flex items-center justify-center p-8 w-full rounded-3xl gap-8'>
          <div className='flex flex-col gap-4'>
            ...
            <p className='bold-32 md:bold-36 text-white'>Our History</p>
        ...
        <div className='bg-orange-50 w-full grid grid-cols-2 md:grid-cols-4 rounded-xl p-4 gap-4'>
          <div className='bg-white flex flex-col px-6 py-10 justify-center rounded-2xl'>
            <p className='bold-32 md:bold-40 text-orange-base'>228,000+</p>
            <p className='regular-16 text-generic-950'>Enrollees</p>
          </div>
          <div className='bg-white flex flex-col px-6 py-10 justify-center rounded-2xl'>
            <p className='bold-32 md:bold-40 text-orange-base'>186+</p>
            <p className='regular-16 text-generic-950'>Staff strength</p>
          </div>
          <div className='bg-white flex flex-col px-6 py-10 justify-center rounded-2xl'>
            <p className='bold-32 md:bold-40 text-orange-base'>9</p>
            <p className='regular-16 text-generic-950'>Locations across Nigeria</p>
          </div>
          <div className='bg-white flex flex-col px-6 py-10 justify-center rounded-2xl'>
            <p className='bold-32 md:bold-40 text-orange-base'>1500+</p>
      ...
      <section className="relative max-container padding-container mt-32">
        <h2 className="bold-32 md:bold-48 text-orange-base mb-8">Our Core Values</h2>
      ...
      <section className="relative max-container padding-container mt-12 md:mt-32">
        <div className="flex flex-col md:flex-row gap-8">
          <div className="border border-orange-base w-full p-12 flex flex-col gap-4 rounded-3xl">
            <p className='regular-14 uppercase bg-orange-700 text-white px-3 py-1 w-fit rounded-full font-gilroy-semibold'>CSR</p>
            <div className="flex items-center gap-3">
              <h2 className="flex-1 bold-32 md:bold-48 text-orange-base w-full">
                Our CSR Impact
              </h2>
              <Link href="/csr">
          ...
          <div className="bg-orange-base w-full p-12 flex flex-col gap-4 rounded-3xl">
            <p className='regular-14 uppercase text-white bg-orange-700 px-3 py-1 w-fit rounded-full font-gilroy-semibold '>Leadership</p>
            <div className="flex items-center gap-3">
