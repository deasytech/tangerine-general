...
import { AVAILABLE_RIDERS } from '@/constants/general'
...
const Page = () => {
  return (
    <>
      <section className="relative max-container padding-container flex flex-col gap-12 md:flex-row items-start w-full mt-24 md:mt-44">
        ...
        <div className="w-full flex-[3]">
          <Image src="/images/general/credit-life-banner.png" alt="group life assurance" width={696} height={364} className="w-full object-contain" />
        </div>
      </section>
