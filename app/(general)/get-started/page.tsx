        ...
        <div className="w-full max-w-3xl flex gap-10 justify-center">
          <Link href="/buy-policy" className="text-center border p-4">
            <div className="w-44 h-44">
              <Image src="/icons/general/retail.svg" alt="retail plan" width={176} height={176} className="" />
            </div>
          ...
          <Link href="/get-started/corporate" className="text-center border p-4">
            <div className="w-44 h-44">
              <Image src="/icons/general/corporate.svg" alt="corporate plan" width={176} height={176} className="" />
            </div>
